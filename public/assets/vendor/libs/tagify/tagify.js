                    ...
                    t.exports = (function() {
                        ...
                        var w = {
                            ...
                            show(t) {
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        (this.suggestedListItems = this.dropdown.filterListItems(
                                            t
                                        )),
                                        t &&
                                            ...
                                            n.templates.dropdownItemNoMatch &&
                                                (a = n.templates.dropdownItemNoMatch.call(
                                                    this,
                                                    { value: t }
                                                ))),
                                        !a)
                            ...
                            fill(t) {
                                ...
                                var e,
                                    i = this.settings.templates.dropdownContent.call(
                                        this,
                                        t
                                    );
                            ...
                            position(t) {
                                ...
                                if ("manual" != e.position) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ("text" == u
                                                ? ((a = (i = this.getCaretGlobalPosition())
                                                      .bottom),
                                                  (s = i.top),
                                                  (n = i.left),
                                                  (o = "auto"))
                                ...
                                binding() {
                                    ...
                                    var e = this.dropdown.events.callbacks,
                                        i = (this.listeners.dropdown = this
                                            .listeners.dropdown || {
                                            position: this.dropdown.position.bind(
                                                this,
                                                null
                                            ),
                                            onKeyDown: e.onKeyDown.bind(this),
                                            onMouseOver: e.onMouseOver.bind(
                                                this
                                            ),
                                            onMouseLeave: e.onMouseLeave.bind(
                                                this
                                            ),
                                    ...
                                    onKeyDown(t) {
                                        if (
                                            ...
                                            var e = this.DOM.dropdown.querySelector(
                                                ...
                                                i = this.dropdown.getSuggestionDataByNode(
                                                    e
                                                );
                                            switch (t.key) {
                                                case "ArrowDown":
                                                ...
                                                case "Tab":
                                                    if (
                                                        ...
                                                        t.preventDefault();
                                                        var n = this.dropdown.getMappedValue(
                                                            i
                                                        );
                                                        return (
                            ...
                            selectOption(t, e) {
                                ...
                                var n = t.getAttribute("value"),
                                    o = "noMatch" == n,
                                    r = this.suggestedListItems.find(
                                        t => (t.value || t) == n
                                    );
                            ...
                            filterListItems(t, e) {
                                ...
                                return (
                                    (this.state.dropdown.suggestions = g.concat(
                                        d
                                    )),
                                ...
                                wrapper: (t, e) =>
                                    `<tags class="${e.classNames.namespace} ${
                                        ...
                                        !e.readonly && e.userInput
                                            ? "contenteditable"
                                            : ""
                                    } tabIndex="0" data-placeholder="${e.placeholder ||
                            ...
                            (M.prototype = {
                                ...
                                applySettings(t, i) {
                                    ...
                                    if (
                                        ...
                                        void 0 ===
                                            s.dropdown.includeSelectedTags &&
                                            (s.dropdown.includeSelectedTags =
                                                s.duplicates),
                                        ...
                                        "mix" == s.mode &&
                                            ...
                                            (s.delimiters =
                                                i.delimiters || null),
                                            s.tagTextProp &&
                                                !s.dropdown.searchKeys.includes(
                                                    s.tagTextProp
                                                ) &&
                                                s.dropdown.searchKeys.push(
                                                    s.tagTextProp
                                                )),
                                        t.pattern)
                                    )
                                ...
                                injectAtCaret(t, e) {
                                    return !(e =
                                        e || this.state.selection?.range) && t
                                ...
                                input: {
                                    ...
                                    autocomplete: {
                                        ...
                                        set(t) {
                                            var e = this.DOM.input.getAttribute(
                                                    "data-suggest"
                                                ),
                                                i =
                                                    t ||

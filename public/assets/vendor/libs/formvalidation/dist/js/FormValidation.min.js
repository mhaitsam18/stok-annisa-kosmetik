(function(global, factory) {
            ...
            validate: function validate(a) {
                ...
                return n.inclusive
                    ? {
                          message: r$2(
                              a.l10n
                                  ? n.message || a.l10n.between["default"]
                                  : n.message,
                              ["".concat(l), "".concat(o)]
                          ),
                    ...
                    : {
                          message: r$2(
                              a.l10n
                                  ? n.message || a.l10n.between.notInclusive
                                  : n.message,
                              ["".concat(l), "".concat(o)]
                          ),
                          valid: parseFloat(t) > l && parseFloat(t) < o
        ...
        return {
            validate: function validate(t) {
                ...
                switch (true) {
                    case !!s && !!n:
                        a = r$2(
                            t.l10n ? t.l10n.choice.between : t.options.message,
                            [s, n]
                        );
                        break;
                    case !!s:
                        a = r$2(
                            t.l10n ? t.l10n.choice.more : t.options.message,
                            s
                        );
                        break;
                    case !!n:
                        a = r$2(
                            t.l10n ? t.l10n.choice.less : t.options.message,
                            n
                        );
                        break;
                }
    ...
    function l$2() {
        return {
            validate: function validate(l) {
                if (l.value === "") {
                    return { meta: { type: null }, valid: true };
                }
                if (/[^0-9-\s]+/.test(l.value)) {
                    return { meta: { type: null }, valid: false };
                }
                ...
                for (
                    var _i = 0, _Object$keys = Object.keys(t$b);
                    ...
                    for (var n in t$b[_e].prefix) {
                        if (
                            l.value.substr(0, t$b[_e].prefix[n].length) ===
                                t$b[_e].prefix[n] &&
                            t$b[_e].length.indexOf(r.length) !== -1
                        ) {
                            return { meta: { type: _e }, valid: true };
                        }
                    }
                }
                return { meta: { type: null }, valid: false };
            ...
            validate: function validate(a) {
                ...
                var l = Object.assign(
                    {},
                    {
                        format:
                            a.element &&
                            a.element.getAttribute("type") === "date"
                                ? "YYYY-MM-DD"
                                : "MM/DD/YYYY",
                        message: ""
                    },
                ...
                if (i) {
                    ...
                    var _e =
                        _t2.length > 0
                            ? _t2[0].length <= 2 && /^\d+$/.test(_t2[0])
                                ? parseInt(_t2[0], 10)
                                : -1
                            : 0;
                    var _n2 =
                        _t2.length > 1
                            ? _t2[1].length <= 2 && /^\d+$/.test(_t2[1])
                                ? parseInt(_t2[1], 10)
                                : -1
                            : 0;
                    var _s =
                        _t2.length > 2
                            ? _t2[2].length <= 2 && /^\d+$/.test(_t2[2])
                                ? parseInt(_t2[2], 10)
                                : -1
                            : 0;
                    if (_e === -1 || _n2 === -1 || _s === -1) {
                ...
                switch (true) {
                    ...
                    case !!b && !!S:
                        return {
                            message: r$2(a.l10n ? a.l10n.date.range : o, [
                                S,
                                b
                            ]),
                            meta: { date: I },
    ...
    function e$8() {
        return {
            validate: function validate(e) {
                ...
                var t;
                var i = e.options.extension
                    ? e.options.extension.toLowerCase().split(",")
                    : null;
                var s = e.options.type
                    ? e.options.type.toLowerCase().split(",")
                    : null;
                var n =
                    window["File"] &&
                    window["FileList"] &&
                ...
                if (n) {
                    ...
                    if (
                        e.options.maxFiles &&
                        o > parseInt("".concat(e.options.maxFiles), 10)
                    ) {
                        return {
                    ...
                    if (
                        e.options.minFiles &&
                        o < parseInt("".concat(e.options.minFiles), 10)
                    ) {
                        return {
                    ...
                    for (var l = 0; l < o; l++) {
                        ...
                        if (
                            e.options.minSize &&
                            _n[l].size <
                                parseInt("".concat(e.options.minSize), 10)
                        ) {
                            return {
                                meta: Object.assign(
                                    {},
                        ...
                        if (
                            e.options.maxSize &&
                            _n[l].size >
                                parseInt("".concat(e.options.maxSize), 10)
                        ) {
                            return {
                                meta: Object.assign(
                                    {},
                        ...
                        if (
                            _n[l].type &&
                            s &&
                            s.indexOf(_n[l].type.toLowerCase()) === -1
                        ) {
                            return {
                                meta: Object.assign(
                                    {},
                    ...
                    if (
                        ...
                        a > parseInt("".concat(e.options.maxTotalSize), 10)
                    ) {
                        return {
                            meta: Object.assign(
                                {},
                    ...
                    if (
                        ...
                        a < parseInt("".concat(e.options.minTotalSize), 10)
                    ) {
                        return {
                            meta: Object.assign(
                                {},
                    ...
                    if (i && i.indexOf(t.toLowerCase()) === -1) {
                        return {
                            meta: { error: "INVALID_EXTENSION", ext: t },
                            valid: false
                        };
                    }
                }
            ...
            validate: function validate(a) {
                ...
                return s.inclusive
                    ? {
                          message: r$2(
                              a.l10n
                                  ? s.message || a.l10n.greaterThan["default"]
                                  : s.message,
                              "".concat(t)
                          ),
                    ...
                    : {
                          message: r$2(
                              a.l10n
                                  ? s.message || a.l10n.greaterThan.notInclusive
                                  : s.message,
                              "".concat(t)
                          ),
                          valid: parseFloat(a.value) > t
    ...
    function a$3() {
        return {
            validate: function validate(a) {
                ...
                var r =
                    e.thousandsSeparator === "." ? "\\." : e.thousandsSeparator;
                var o = new RegExp(
                    "^-?[0-9]{1,3}("
                        .concat(r, "[0-9]{3})*(")
                        .concat(t, "[0-9]+)?$")
            ...
            validate: function validate(s) {
                ...
                return a.inclusive
                    ? {
                          message: r$2(
                              s.l10n
                                  ? a.message || s.l10n.lessThan["default"]
                                  : a.message,
                              "".concat(l)
                          ),
                    ...
                    : {
                          message: r$2(
                              s.l10n
                                  ? a.message || s.l10n.lessThan.notInclusive
                                  : a.message,
                              "".concat(l)
                          ),
                          valid: parseFloat(s.value) < l
        ...
        return {
            validate: function validate(e) {
                ...
                if (t instanceof RegExp) {
                    return { valid: t.test(e.value) };
                } else {
                    var n = t.toString();
                    var o = e.options.flags
                        ? new RegExp(n, e.options.flags)
                        : new RegExp(n);
                    return { valid: o.test(e.value) };
                }
            }
        };
    }
    ...
    function t$7(t, n) {
        ...
        return new Promise(function(s, a) {
            var r = Object.assign(
                {},
                { crossDomain: false, headers: {}, method: "GET", params: {} },
                n
            );
            var d = Object.keys(r.params)
                .map(function(e) {
                    return ""
                        .concat(encodeURIComponent(e), "=")
                        .concat(encodeURIComponent(r.params[e]));
                })
                .join("&");
            var c = t.indexOf("?");
            var i =
    ...
    function a$1() {
        ...
        return {
            validate: function validate(t) {
                ...
                var o =
                    "function" === typeof s.url ? s.url.call(this, t) : s.url;
                return t$7(o, {
    ...
    function e$5() {
        return {
            validate: function validate(e) {
                ...
                var a = Object.assign({}, { case: "lower" }, e.options);
    ...
    function t$6() {
        ...
        return {
            validate: function validate(s) {
                var n = Object.assign(
                    {},
                    { message: "", trim: false, utf8Bytes: false },
                    s.options
                );
                var a =
                    n.trim === true || "".concat(n.trim) === "true"
                        ? s.value.trim()
                        : s.value;
                if (a === "") {
                    return { valid: true };
                ...
                var g = true;
                var m = s.l10n
                    ? n.message || s.l10n.stringLength["default"]
                    : n.message;
                ...
                switch (true) {
                    case !!r && !!l:
                        m = r$2(
                            s.l10n
                                ? n.message || s.l10n.stringLength.between
                                : n.message,
                            [r, l]
                        );
                        break;
                    case !!r:
                        m = r$2(
                            s.l10n
                                ? n.message || s.l10n.stringLength.more
                                : n.message,
                    ...
                    case !!l:
                        m = r$2(
                            s.l10n
                                ? n.message || s.l10n.stringLength.less
                                : n.message,
                            "".concat(parseInt(l, 10))
                        );
                        break;
                }
    ...
    function t$5() {
        ...
        return {
            validate: function validate(o) {
                ...
                var l =
                    a.allowLocal === true || "".concat(a.allowLocal) === "true";
                var f =
                    a.allowEmptyProtocol === true ||
        ...
        _createClass(l, [
            ...
            },
            {
                ...
                value: function registerPlugin(e, t) {
                    if (this.plugins[e]) {
                        throw new Error(
                            "The plguin ".concat(e, " is registered")
                        );
                    }
                    t.setCore(this);
                    t.install();
            ...
            },
            {
                ...
                value: function validate() {
                    ...
                    return this.filter
                        ...
                        .then(function() {
                            return Promise.all(
                                Object.keys(_this.fields).map(function(e) {
            ...
            },
            {
                ...
                value: function validateElement(e, t) {
                    ...
                    var i = this.elements[e];
                    var s = this.filter.execute("element-ignored", false, [
                        e,
                        t,
                        i
                    ]);
            ...
            },
            {
                ...
                value: function executeValidator(e, t, i, s) {
                    ...
                    var o = this.filter.execute("field-should-validate", true, [
                        e,
                        t,
                        d,
                        i
            ...
            },
            {
                ...
                value: function getElementValue(e, t, s) {
                    ...
                    return this.filter.execute("field-value", _l4, [
                        _l4,
                        e,
                        t,
                        s
    ...
    var t$4 = (function() {
        ...
        _createClass(t, [
            ...
            { key: "install", value: function install() {} },
            { key: "uninstall", value: function uninstall() {} }
        ]);
        return t;
    })();
    var index$2 = { getFieldValue: e$a };
    var e$4 = (function(_t) {
        _inherits(e, _t);
        ...
        function e(t) {
            ...
            _this.opts = t || {};
            _this.validatorNameFilter = _this.getValidatorName.bind(
    ...
    var i$3 = (function(_e) {
        ...
        function i() {
            ...
            _this.elementValidatedHandler = _this.onElementValidated.bind(
                _assertThisInitialized(_this)
            );
            _this.fieldValidHandler = _this.onFieldValid.bind(
                _assertThisInitialized(_this)
            );
            _this.fieldInvalidHandler = _this.onFieldInvalid.bind(
                _assertThisInitialized(_this)
            );
            _this.messageDisplayedHandler = _this.onMessageDisplayed.bind(
                _assertThisInitialized(_this)
            );
            return _this;
        }
    ...
    var t$3 = (function(_e) {
        ...
        function t(e) {
            ...
            _this.fieldAddedHandler = _this.onFieldAdded.bind(
                _assertThisInitialized(_this)
            );
            _this.fieldRemovedHandler = _this.onFieldRemoved.bind(
                _assertThisInitialized(_this)
            );
            return _this;
        }
        _createClass(t, [
            ...
            },
            {
                ...
                value: function parseOptions() {
                    ...
                    var i = [].slice.call(
                        a.querySelectorAll("[name], [".concat(e, "field]"))
                    );
            ...
            },
            {
                ...
                value: function createPluginInstance(e, _t6) {
                    ...
                    if (typeof a !== "function") {
                        throw new Error(
                            "the plugin ".concat(e, " doesn't exist")
                        );
                    }
                    return new a(_t6);
                }
            ...
            },
            {
                ...
                value: function isEmptyOption(e) {
                    ...
                    return (
                        Object.keys(_t10).length === 0 &&
                        _t10.constructor === Object
                    );
                }
            },
            {
                            ...
                            switch (true) {
                                case "minlength" === _s3:
                                    a["stringLength"] = Object.assign(
                                        {},
                                        { enabled: true, min: parseInt(r, 10) },
                                        a["stringLength"]
                                    );
                                    break;
                                case "maxlength" === _s3:
                                    a["stringLength"] = Object.assign(
                                        {},
                                        { enabled: true, max: parseInt(r, 10) },
                                        a["stringLength"]
                                    );
                                    break;
                                case "pattern" === _s3:
                        ...
                        if (l && l.length === 4) {
                            ...
                            a[_e4] = Object.assign(
                                ...
                                l[3]
                                    ? _defineProperty(
                                          {},
                                          this.toCamelCase(l[3]),
                                          this.normalizeValue(r)
                                      )
                                    : { enabled: "" === r || "true" === r },
                                a[_e4]
                            );
    ...
    var o = (function(_t) {
        ...
        function o() {
            ...
            _this = _super.call(this, {});
            _this.onValidHandler = _this.onFormValid.bind(
                _assertThisInitialized(_this)
            );
            return _this;
        }
        _createClass(o, [
            {
                ...
                value: function install() {
                    ...
                    if (
                        t.querySelectorAll('[type="submit"][name="submit"]')
                            .length
                    ) {
                        throw new Error(
    ...
    var e$3 = (function(_t) {
        ...
        function e(t) {
            ...
            _this = _super.call(this, t);
            _this.opts = t || {};
            _this.triggerExecutedHandler = _this.onTriggerExecuted.bind(
                _assertThisInitialized(_this)
            );
            return _this;
        }
    ...
    var e$2 = (function(_t) {
        ...
        function e(t) {
            ...
            _classCallCheck(this, e);
            _this = _super.call(this, t);
            _this.opts = Object.assign({}, { excluded: e.defaultIgnore }, t);
            _this.ignoreValidationFilter = _this.ignoreValidation.bind(
                _assertThisInitialized(_this)
            );
            return _this;
        }
            ...
            [
                {
                    ...
                    value: function defaultIgnore(t, _e, i) {
                        var r = !!(
                            _e.offsetWidth ||
                            _e.offsetHeight ||
                            _e.getClientRects().length
                        );
                        var n = _e.getAttribute("disabled");
                        return (
                            n === "" ||
                            n === "disabled" ||
                            _e.getAttribute("type") === "hidden" ||
                            !r
                        );
                    }
                }
    ...
    var t$2 = (function(_e) {
        ...
        function t(e) {
            ...
            _this.elementValidatingHandler = _this.onElementValidating.bind(
                _assertThisInitialized(_this)
            );
            _this.elementValidatedHandler = _this.onElementValidated.bind(
                _assertThisInitialized(_this)
            );
            _this.elementNotValidatedHandler = _this.onElementNotValidated.bind(
                _assertThisInitialized(_this)
            );
            _this.elementIgnoredHandler = _this.onElementIgnored.bind(
                _assertThisInitialized(_this)
            );
            _this.fieldAddedHandler = _this.onFieldAdded.bind(
                _assertThisInitialized(_this)
        ...
        _createClass(t, [
            ...
            },
            {
                ...
                value: function areFieldsValid() {
                    return Array.from(this.statuses.values()).every(function(
                        e
                    ) {
                        return (
                            e === "Valid" ||
    ...
    var s$1 = (function(_e) {
        ...
        function s(e) {
            ...
            _this.validatorValidatedHandler = _this.onValidatorValidated.bind(
                _assertThisInitialized(_this)
            );
            _this.validatorNotValidatedHandler = _this.onValidatorNotValidated.bind(
                _assertThisInitialized(_this)
            );
            return _this;
        }
            ...
            [
                {
                    ...
                    value: function install() {
                        ...
                        this.core
                            .on(
                                "core.element.ignored",
                                this.elementIgnoredHandler
                            )
                            .on("core.field.added", this.fieldAddedHandler)
                            .on("core.field.removed", this.fieldRemovedHandler)
                            .on(
                        ...
                        if (t.length) {
                            ...
                            if ("radio" === _s12 || "checkbox" === _s12) {
                                ...
                                t.forEach(function(_s4) {
                                    return _this4.prepareElementContainer(
                                        e,
                                        _s4,
                                        t
                                    );
                ...
                },
                {
                    ...
                    value: function prepareElementContainer(e, _s5, i) {
                        ...
                        if ("string" === typeof this.opts.container) {
                            var _e2 =
                                "#" === this.opts.container.charAt(0)
                                    ? '[id="'.concat(
                                          this.opts.container.substring(1),
                                          '"]'
                                      )
                                    : this.opts.container;
                        ...
                        a.appendChild(l);
                        c(l, { "fv-plugins-message-container": true });
                ...
                },
                {
                    ...
                    value: function onElementIgnored(e) {
                        ...
                        var i =
                            "radio" === _s10 || "checkbox" === _s10
                                ? t[0]
                                : e.element;
                        if (this.messages.has(i)) {
                            var _t4 = this.messages.get(i);
                            var _s15 = [].slice.call(
                                _t4.querySelectorAll(
    ...
    var l = (function(_e) {
        ...
        function l(e) {
            ...
            _this.iconPlacedHandler = _this.onIconPlaced.bind(
                _assertThisInitialized(_this)
            );
            _this.fieldAddedHandler = _this.onFieldAdded.bind(
                _assertThisInitialized(_this)
            ...
            _this.messagePlacedHandler = _this.onMessagePlaced.bind(
                _assertThisInitialized(_this)
            );
            return _this;
        }
        _createClass(l, [
                        ...
                        this.core.registerPlugin(
                            ...
                            new s$1({
                                ...
                                container: function container(e, t) {
                                    var _l =
                                        "string" ===
                                        typeof _this2.opts.rowSelector
                                            ? _this2.opts.rowSelector
                                            : _this2.opts.rowSelector(e, t);
                                    var a = t$1(t, _l);
                                    return s$1.getClosestContainer(
                                        t,
                                        a,
                                        _this2.opts.rowPattern
                                    );
                                }
                            })
                        );
            ...
            { key: "onIconPlaced", value: function onIconPlaced(e) {} },
            { key: "onMessagePlaced", value: function onMessagePlaced(e) {} },
            {
                key: "onFieldAdded",
                value: function onFieldAdded(e) {
                    var _this3 = this;
                        ...
                        s.forEach(function(e) {
                            ...
                            if (s) {
                                ...
                                c(
                                    ...
                                    _defineProperty(
                                        _t3,
                                        _this3.opts.rowInvalidClass,
                                        false
                                    ),
                                    _defineProperty(
                                        _t3,
                                        _this3.opts.rowValidatingClass,
                                        false
                                    ),
                                    _defineProperty(
                                        _t3,
                                        _this3.opts.rowValidClass,
                                        false
                                    ),
                                    _defineProperty(
                                        _t3,
                    ...
                    e.elements.forEach(function(e) {
                        ...
                        if (s) {
                            ...
                            c(
                                ...
                                _defineProperty(
                                    _t4,
                                    _this4.opts.rowInvalidClass,
                                    false
                                ),
                                _defineProperty(
                                    _t4,
                                    _this4.opts.rowValidatingClass,
                                    false
                                ),
                                _defineProperty(
                                    _t4,
                                    _this4.opts.rowValidClass,
                                    false
                                ),
                                _t4)
                            );
            ...
            },
            {
                ...
                value: function onElementValidating(e) {
                    ...
                    var i = e.element.getAttribute("type");
                    var _l3 =
                        "radio" === i || "checkbox" === i ? s[0] : e.element;
                    ...
                    if (a) {
                        ...
                        c(
                            ...
                            _defineProperty(
                                _t6,
                                this.opts.rowInvalidClass,
                                false
                            ),
                            _defineProperty(
                                _t6,
                                this.opts.rowValidatingClass,
                                true
                            ),
                            _defineProperty(
                                _t6,
                                this.opts.rowValidClass,
                                false
                            ),
                            _t6)
                        );
                ...
                value: function removeClasses(e, s) {
                    ...
                    s.forEach(function(e) {
                        ...
                        c(
                            ...
                            _defineProperty(
                                _t7,
                                _this6.opts.eleValidClass,
                                false
                            ),
                            _defineProperty(
                                _t7,
                                _this6.opts.eleInvalidClass,
                                false
                            ),
                            _t7)
                        );
                ...
                value: function onElementValidated(e) {
                    ...
                    s.forEach(function(s) {
                        ...
                        c(
                            ...
                            _defineProperty(
                                _t9,
                                _this7.opts.eleValidClass,
                                e.valid
                            ),
                            _defineProperty(
                                _t9,
                                _this7.opts.eleInvalidClass,
                                !e.valid
                            ),
                            _t9)
                        );
    ...
    var i$1 = (function(_e) {
        ...
        function i(e) {
            ...
            _this.opts = Object.assign({}, { enabled: true }, e);
            _this.validatorHandler = _this.onValidatorValidated.bind(
                _assertThisInitialized(_this)
            );
            _this.shouldValidateFilter = _this.shouldValidate.bind(
                _assertThisInitialized(_this)
            );
            _this.fieldAddedHandler = _this.onFieldAdded.bind(
                _assertThisInitialized(_this)
                ...
                value: function shouldValidate(e, _i, t, l) {
                    var d =
                        (this.opts.enabled === true ||
                            this.opts.enabled[e] === true) &&
                        this.invalidFields.has(_i) &&
                        !!this.invalidFields.get(_i).length &&
                        this.invalidFields.get(_i).indexOf(l) === -1;
                    return !d;
                }
            },
            {
                key: "onValidatorValidated",
                value: function onValidatorValidated(e) {
                    var _i2 = this.invalidFields.has(e.element)
    ...
    var e = (function(_t) {
        ...
        function e(t) {
            ...
            _this.submitHandler = _this.handleSubmitEvent.bind(
                _assertThisInitialized(_this)
            );
            _this.buttonClickHandler = _this.handleClickEvent.bind(
                _assertThisInitialized(_this)
            );
            return _this;
        }
        _createClass(e, [
            {
                ...
                value: function install() {
                    var _this2 = this;
                    if (
                        !(this.core.getFormElement() instanceof HTMLFormElement)
                    ) {
                        return;
                    }
                    var t = this.core.getFormElement();
            ...
            },
            {
                ...
                value: function validateForm(t) {
                    ...
                    this.core.validate().then(function(t) {
                        if (
                            t === "Valid" &&
                            _this4.opts.aspNetButton &&
                            !_this4.isFormValid &&
                            _this4.clickedButton
                        ) {
                            _this4.isFormValid = true;
                            _this4.clickedButton.removeEventListener(
                                "click",
                                _this4.buttonClickHandler
                            );
    ...
    var i = (function(_t) {
        ...
        function i(t) {
            ...
            _this.documentClickHandler = _this.onDocumentClicked.bind(
                _assertThisInitialized(_this)
            );
            return _this;
        }
        _createClass(i, [
            ...
            },
            {
                ...
                value: function onIconPlaced(t) {
                    var _this2 = this;
                    c(t.iconElement, { "fv-plugins-tooltip-icon": true });
                    switch (this.opts.trigger) {
                        case "hover":
                            t.iconElement.addEventListener(
                                "mouseenter",
                                function(e) {
                        ...
                        case "click":
                        default:
                            t.iconElement.addEventListener("click", function(
                                e
                            ) {
                                return _this2.show(t.element, e);
                            });
            ...
            },
            {
                ...
                value: function show(t, _i3) {
                    ...
                    c(this.tip, { "fv-plugins-tooltip--hide": false });
            ...
            },
            {
                key: "hide",
                value: function hide() {
                    c(this.tip, { "fv-plugins-tooltip--hide": true });
                }
            }
        ]);
        return i;
    ...
    var t = (function(_e) {
        ...
        function t(e) {
            ...
            _this.opts = Object.assign(
                {},
                { delay: 0, event: _this.defaultEvent, threshold: 0 },
                e
            );
            _this.fieldAddedHandler = _this.onFieldAdded.bind(
                _assertThisInitialized(_this)
        ...
        _createClass(t, [
            ...
            },
            {
                ...
                value: function uninstall() {
                    this.handlers.forEach(function(e) {
                        return e.element.removeEventListener(
                            e.event,
                            e.handler
                        );
                    });
            ...
            },
            {
                ...
                value: function prepareHandler(e, _t2) {
                    ...
                    _t2.forEach(function(_t3) {
                        ...
                        if (
                            !!_this2.opts.event &&
                            _this2.opts.event[e] === false
                        ) {
                            i = [];
                        } else if (
                            !!_this2.opts.event &&
                            !!_this2.opts.event[e] &&
                            typeof _this2.opts.event[e] !== "function"
                        ) {
                            i = _this2.opts.event[e].split(" ");
                        } else if (
                            "string" === typeof _this2.opts.event &&
                            _this2.opts.event !== _this2.defaultEvent
                        ) {
            ...
            },
            {
                ...
                value: function handleEvent(e, _t4, i) {
                    var _this3 = this;
                    if (
                        this.exceedThreshold(_t4, i) &&
                        this.core.executeFilter(
                        ...
                        var s = function s() {
                            return _this3.core
                                .validateElement(_t4, i)
                                .then(function(s) {
                                    _this3.core.emit(
                                        "plugins.trigger.executed",
                                        { element: i, event: e, field: _t4 }
                                    );
                                });
                        };
                ...
                value: function onFieldRemoved(e) {
                    this.handlers
                        .filter(function(_t6) {
                            return (
                                _t6.field === e.field &&
                                e.elements.indexOf(_t6.element) >= 0
                            );
                        })
                        .forEach(function(e) {
                            return e.element.removeEventListener(
